...
export default function About() {
    ...
    return (
        <div ref={containerRef} className="pt-40 md:pt-50 lg:pt-64 bg-[url('/waves/wave-1-beige.svg')] bg-repeat-x bg-right-top transition-[padding] relative overflow-hidden">

            <div className="w-full flex flex-col justify-center items-center gap-14 bg-hackBeige font-mont overflow-x-clip" id="about">
                ...
                <div className="flex flex-col justify-center items-center gap-6">
                    ...
                    <div className="flex flex-col md:flex-row justify-center items-center gap-6 md:gap-2 lg:gap-12 lg:w-4/5">
                        ...
                        <div className="text-center w-4/5 md:w-1/3">
                            ...
                            <a href="/register" target="_blank" className="underline"> Click Here! </a>
                        </div>
                    </div>
                    <div className="flex flex-col-reverse md:flex-row justify-center items-center gap-6 md:gap-8 lg:gap-12 w-9/12 lg:w-4/6 xl:w-1/2 pt-12 md:pt-2">
                        ...
                        <img src="/images/rec-map.png" alt="Hackathon Map" className="w-4/5 md:w-1/2 lg:w-[45%] rounded-[32px]"/>
                    </div>
                </div>
            </div>
