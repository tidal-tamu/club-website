...
export default function Navbar({dark = false}: NavbarProps) {
    ...
    return (
        <nav className={`relative z-10 w-full font-mont font-semibold text-nowrap flex sm:flex-row flex-col lg:justify-between items-center p-6 pt-10 px-10 gap-6 xl:pl-32 sm:pr-40 lg:py-9 lg:gap-20 transition-[padding] ${
