  ...
  return (
    <div>
      ...
      >
        ...
        <div className="text-center z-20 max-w-4xl mx-auto mt-6 md:mt-[-60px]">
      ...
      <div className="translate-y-[-200%] flex flex-row justify-center">
        <button
          ...
          className="flex flex-col items-center justify-center animate-bounce text-3xl text-white transition hover:scale-125 hover:text-[#FFA722] duration-300 focus:outline-none"
          type="button"
        >
