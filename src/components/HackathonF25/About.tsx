  ...
  return (
    <div className="relative px-6 md:px-16 pt-20">
      <div className="flex flex-col md:flex-row justify-around">
        <div className="flex flex-col items-center md:w-1/3">
          ...
          <p className="text-white font-inter font-light text-base md:text-lg">
            TidalHack Fall 2025 is a <span className="font-bold">9 hour</span> event <span className="font-bold">where data science and machine learning</span> enthusiasts come together to build open ended ML projects!
            <br />
            <br />
        ...
        <div className="flex flex-col items-start md:w-1/3">
          ...
          <p className="text-white font-inter font-light text-base md:text-lg mb-3">
            MSC Bethancourt Ballroom (MSC 2300)<br />275 Joe Routt Blvd, College Station, TX 77843
          </p>
          <span className="text-[#FFA722] font-bungee text-xl md:text-2xl">
            PARKING
          </span>
      ...
      <div className="flex flex-row justify-center items-center my-40 h-40">
        <img src="/f25/image 31.png" className="rounded-lg shadow-lg object-contain" alt="Image 1" />
        <img src="/f25/image 32.png" className="rounded-lg shadow-lg object-contain" alt="Image 2" />
        <img src="/f25/IMG_7713 1.png" className="rounded-lg shadow-lg object-contain" alt="Image 3" />
      </div>
    </div>
  );
}
