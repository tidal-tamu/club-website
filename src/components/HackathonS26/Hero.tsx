            ...
            <div className="relative min-h-screen flex items-center justify-center px-6 md:px-12 select-none">
                ...
                <div className="absolute inset-0 z-0">
                    ...
                    <img
                        ...
                        alt="Low Hill"
                        className="absolute bottom-8 left-0 sm:bottom-10 sm:left-0 w-screen h-[33%] slide-up-1"
                    />
                </div>
                ...
                <div className="absolute w-screen inset-0 z-10 overflow-hidden">
                    <img
                        ...
                        className="absolute md:right-0 bottom-[18vh] -translate-x-32 sm:translate-x-8 md:translate-x-16 lg:translate-x-20 xl:translate-x-24 2xl:translate-x-28 h-full min-w-[700px] slide-up-1"
                    />
                </div>
