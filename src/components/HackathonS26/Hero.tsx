    ...
    <div ref={heroRef} className="relative min-h-screen flex items-center justify-center px-6 md:px-12 select-none">
      <div className="absolute inset-0 z-0">
        ...
        <img
          ...
          alt="Low Hill"
          className="absolute bottom-8 left-5 sm:bottom-10 sm:left-0 right-0 w-full min-w-0 h-[33%] slide-up-1"
          decoding="async"
        />
      </div>

      <div className="absolute inset-0 w-full min-w-0 z-7 overflow-hidden" style={{ left: 0, right: 0 }}>
        <img
      ...
      <div className="absolute inset-0 w-full min-w-0 z-5" style={{ left: 0, right: 0 }}>
        <img
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute bottom-0 left-0 right-0 overflow-hidden w-full">
          ...
          <div
            className="h-[8rem]"
            style={{
              background: "linear-gradient(to bottom, #77A5C6, #77A5C6)",
            }}
          />
        </div>
      </div>
      ...
      <div className="absolute left-0 z-10 bottom-[5rem] lg:bottom-[8rem] overflow-hidden">
        ...
        <img
          ...
          decoding="async"
        />
        <span ref={rustleRef} className="absolute bottom-[5rem] lg:bottom-[8rem] left-[100px] md:left-[125px] lg:left-[163px] xl:left-[200px] translate-y-full text-4xl animate-rustle">rustle</span>
      </div>
