        ...
        <div className="hackathon-s26-container min-h-screen">
            ...
            >
                ...
                <img
                    ...
                    alt="Penguin Cover"
                    className={`absolute bottom-0 left-0 z-40 pointer-events-none w-[200px] sm:w-[250px] md:w-[300px] lg:w-[380px] xl:w-[442px] h-auto transition-opacity duration-300 ${
                ...
                <Link
                    to="/register"
                    className={`absolute bottom-2 right-4 translate-x-0 sm:bottom-24 sm:right-28 sm:translate-x-0 md:bottom-28 md:right-36 lg:bottom-36 lg:right-44 xl:bottom-36 xl:right-44 z-30 cursor-pointer transition-all duration-200 hover:scale-105 group inline-block ${
