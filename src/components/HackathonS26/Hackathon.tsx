...
const HackathonS26 = () => {
    ...
    useEffect(() => {
      ...
      * {
      ...
      button, a, input, select, label, a *, img {
            ...
            {!isLoading && (
                <div className="hackathon-s26-container min-h-screen">
                    ...
                    >
                        ...
                        <Link
                            to="/register"
                            className={`hidden sm:flex absolute right-4 sm:right-8 z-30 !cursor-pointer transition-all duration-200 group inline-block ${
                                isMobileMenuOpen
                        ...
                        >
                            <img
                                src="/s26/snowman.png"
                                alt="Snowman"
                                className="w-20 h-20 sm:w-32 sm:h-32 md:w-36 md:h-36 lg:w-40 lg:h-40 xl:w-44 xl:h-44 object-contain opacity-90 hover:opacity-100 transition-opacity duration-200 group-hover:animate-jiggle block cursor-pointer !cursor-pointer"
                            />
                        </Link>
