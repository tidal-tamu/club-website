export default function About() {
    return (
        <div>
            <div className="w-full flex flex-col justify-center items-center gap-16 bg-lightBlue overflow-x-clip">
                ...
                <div className="xl:min-w-[1024px] relative flex flex-col xl:flex-row-reverse justify-center items-center gap-10 bg-white rounded-3xl mx-32 flex-0 px-8 py-10 xl:px-24 xl:py-36">
                    ...
                    <img
                        ...
                        className="absolute bottom-0 right-0 translate-x-1/2 translate-y-1/2 w-[125px] xl:w-[250px] z-10"
                    />
                </div>
            </div>
        </div>
