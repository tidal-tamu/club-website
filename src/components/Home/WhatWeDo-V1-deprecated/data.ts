...
export const titles = [
  ...
  export const bodies = [
    ...
    "Participate in TIDAL hosted machine learning competitions to win small prizes and build your skills!",
    "Join a team to develop a unqiue project over the semester, collaborating with industry professionals, A&M professors, or other students on developing unique AI solutions to existing issues.",
